...
> implements CommonResolverApi<
  ...
  where(filter: <%= entity %>FilterInput): any {
    return this.clone({ filter }) as any;
  }

  /** AND with existing filter */
  whereAnd(...nodes: readonly <%= entity %>FilterNode[]): this;
  whereAnd(...nodes: readonly <%= entity %>FilterNode[]): <%= entity %>Resolver<T, S, P>;
  whereAnd(...nodes: readonly <%= entity %>FilterNode[]): any {
  ...
  whereOr(...nodes: readonly <%= entity %>FilterNode[]): this;
  whereOr(...nodes: readonly <%= entity %>FilterNode[]): <%= entity %>Resolver<T, S, P>;
  whereOr(...nodes: readonly <%= entity %>FilterNode[]): any {
    const next = this.state.filter
  ...
  select(...fields: readonly <%= entity %>SelectField[]): any {
