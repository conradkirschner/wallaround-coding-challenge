...
> implements CommonResolverApi<
  ...
  where(filter: AddressFilterInput): any {
    return this.clone({ filter }) as any;
  }

  /** AND with existing filter */
  whereAnd(...nodes: readonly AddressFilterNode[]): this;
  whereAnd(...nodes: readonly AddressFilterNode[]): AddressResolver<T, S, P>;
  whereAnd(...nodes: readonly AddressFilterNode[]): any {
  ...
  whereOr(...nodes: readonly AddressFilterNode[]): this;
  whereOr(...nodes: readonly AddressFilterNode[]): AddressResolver<T, S, P>;
  whereOr(...nodes: readonly AddressFilterNode[]): any {
    const next = this.state.filter
  ...
  select(...fields: readonly AddressSelectField[]): any {
