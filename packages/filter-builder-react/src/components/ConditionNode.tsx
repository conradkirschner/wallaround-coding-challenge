...
export const ConditionNodeEditor: React.FC<ConditionNodeEditorProps> = React.memo(function ConditionNodeEditor({
                                                                                                                   node,
                                                                                                                   schema,
                                                                                                                   onChange,
                                                                                                                   onRemove,
    ...
    if (hasNoCompatibleOps || !effectiveField || !currentOp) {
        return (
            ...
            >
                ...
                >
                    No operators available for type “{effectiveField?.type ?? 'unknown'}”. Adjust your operator map.
                </div>
            </ConditionFrame>
        );
    }
